ITEM.name = "Топорик"
ITEM.description = "Маленький топорик с пошатывающейся деревянной рукоятью. Заточен плохо, но, в принципе, в этом есть один плюс - в случае попадания по незащищенным частям тела он сможет гарантировать множество порезов, а также то, что части металла смогут застрять в теле врага. К слову, кидаться им не стоит - слишком тяжелый даже для маленького топорика."
