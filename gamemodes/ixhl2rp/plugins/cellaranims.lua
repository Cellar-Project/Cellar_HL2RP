...
ix.anim.SetModelClass("models/cellar/characters/city3/pla/female/female_pla.mdl", "cellarOTA")
...
ix.anim.SetModelClass("models/cellar/custom/valk_male.mdl", "cellarMale")
ix.anim.SetModelClass("models/cellar/custom/valk_female", "cellarFemale")
