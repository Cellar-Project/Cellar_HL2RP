...
function PLUGIN:HUDPaint() -- using HUDPaint instead of think to call the function only on client-side
    ...
    if character:GetFaction() == FACTION_VORTIGAUNT or character:GetFaction() == FACTION_CITIZEN or character:IsOTA() or character:IsCityAdmin() or character:IsCWU() then 
