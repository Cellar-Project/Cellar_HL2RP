...
if (SERVER) then
	...
	function ENT:Initialize()
		...
		timer.Create( self.timer_name, conf_phasetime, 0, function()
			...
			for _, mat in pairs({"de_cbble/grassdirt_blend",
								 "nature/blenddirtdirt001a",
								 "highdef/metro2033/floor/floor_beton_pol_dirt3"}) do
				if SurfaceInfo:GetMaterial() == mat then
					correctMaterial = true
				end
			end
			if self:OnGround() and correctMaterial then
