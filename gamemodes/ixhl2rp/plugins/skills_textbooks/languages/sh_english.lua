...
LANGUAGE = {
	...
	studiedSkillTextbook = "You have completed %s of %s %s skill volumes and gaines %s XP.",
	skillTextbookPreviousVolume = "You have to complete previous skill textbook to proceed to next!"
}
