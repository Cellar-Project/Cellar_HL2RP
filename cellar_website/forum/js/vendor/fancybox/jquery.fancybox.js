...
(function (window, document, $, undefined) {
  ...
  $.extend(FancyBox.prototype, {
    ...
    addContent: function (content) {
      ...
      this.modifyContent(content, function(obj)
      {
        self.group.push(obj);
      });
    },
    ...
    prependContent: function (content) {
      ...
      this.modifyContent(content, function(obj)
      {
        self.group.unshift(obj);
      });
    },

    modifyContent: function (content, applyFn) {
      var self = this,
    ...
    reindexSlides: function () {
      ...
      this.group.forEach(function (slide, index)
      {
        slide.index = index;
      });
