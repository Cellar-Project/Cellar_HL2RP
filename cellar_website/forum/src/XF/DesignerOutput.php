...
class DesignerOutput
{
	...
	protected $assetsFilename = 'assets.json';
	...
	protected function getAssetsFileName($designerMode)
	{
		$ds = \XF::$DS;
		return "{$this->basePath}{$ds}{$designerMode}{$ds}{$this->assetsFilename}";
	}

	public function getAssets($designerMode)
	{
	...
	public function rebuildAssetsFile(\XF\Entity\Style $style)
	{
		if (!$this->isDesignerModeEnabled($style))
		{
			return false;
