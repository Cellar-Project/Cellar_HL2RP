...
use function in_array, is_integer;
...
class Currency
{
	...
	public function languageFormat($value, $currencyCode, \XF\Language $language = null, $format = null)
	{
		...
		{
			return $language->currencyFormat($value, $currency['symbol'], $precision ?? $currency['precision'], $format);
		}
		else
		{
			return $language->currencyFormat($value, $currencyCode, $precision ?? 2, $format);
		}
	}
	...
	public function getCurrencyData()
	{
		...
		return [
			...
			'IRR' => ['code' => 'IRR', 'symbol' => 'IRR',	'precision' => 0, 'phrase' => 'currency.irr'],
