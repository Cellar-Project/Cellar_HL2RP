...
abstract class TreeContentPermissions extends AbstractContentPermissions
{
	...
	protected function buildForChildrenOf($contentId, array $userGroupIds, $userId, array $basePerms)
	{
	...
	protected function buildForContent($contentId, array $userGroupIds, $userId, array $basePerms)
	{
