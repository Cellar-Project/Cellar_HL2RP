...
class Log extends AbstractController
{
	...
	{
		return $this->plugin('XF:AdminSection')->actionView('logs');
	}
	...
	public function actionUsernameChangeToggle()
	{
		...
		return $plugin->actionToggle('XF:UsernameChange', 'visible');
	}
	 ...
	 *
	 * @return \XF\Mvc\Entity\Entity|\XF\Entity\UsernameChange
	 * @throws \XF\Mvc\Reply\Exception
	 */
	protected function assertUsernameChangeLogExists($id, $with = null, $phraseKey = null) : \XF\Entity\UsernameChange
	{
		return $this->assertRecordExists('XF:UsernameChange', $id, $with, $phraseKey);
	}
