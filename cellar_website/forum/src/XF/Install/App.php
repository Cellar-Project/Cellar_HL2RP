...
class App extends \XF\App
{
	...
	protected function getInstallerPhrases()
	{
		return [
			...
			'php_version_x_outdated_upgrade' => 'Your server is running an outdated and unsupported version of PHP ({version}). If possible, you should upgrade to PHP 5.6 or newer (we recommend PHP 8.0) to benefit from improved security and performance.',
