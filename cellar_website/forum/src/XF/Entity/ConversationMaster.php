 ...
 */
class ConversationMaster extends Entity implements LinkableInterface
{
	...
	{
		$route = $canonical ? 'canonical:conversations' : 'conversations';
	...
	{
		return \XF::phrase('conversation_x', ['title' => $this->title]);
	}
