...
class ProfilePost extends Entity implements RenderableContentInterface, LinkableInterface
{
	...
	public function canView(&$error = null)
	{
		...
		if (!$this->ProfileUser->canViewPostsOnProfile($error))
		{
			return false;
		}
	...
	{
		return \XF::visitor()->hasPermission('profilePost', 'viewAttachment');
	}
	...
	{
		return \XF::phrase('profile_post_by_x', ['name' => $this->username]);
	}
