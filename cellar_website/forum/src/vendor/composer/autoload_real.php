...
class ComposerAutoloaderInitd298625c1d7d68572729c189dccea078
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitd298625c1d7d68572729c189dccea078::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequired298625c1d7d68572729c189dccea078($fileIdentifier, $file);
        }
...
function composerRequired298625c1d7d68572729c189dccea078($fileIdentifier, $file)
{
